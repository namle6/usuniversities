...
function editCardContent(card, schoolName, school) {
...
function addSchool(schoolName, rank, acceptanceRate, tuition, imageURL) {
    schools[schoolName] = {
        rank: rank,
...
function addNewSchool() {
    ...
    showCards(); // Refresh the cards to display the newly added school
}
